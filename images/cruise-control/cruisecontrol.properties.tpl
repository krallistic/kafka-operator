...
bootstrap.servers=${BOOTSTRAP_BROKER}
...
# The broker's disk capacity in megabytes.
broker.disk.capacity.mb=1000000

# The broker's CPU capacity in percentage.
broker.cpu.capacity=100.0

# The broker's network inbound bandwidth in KB/s
broker.network.inbound.capacity=100000

# The broker's network output bandwidth in KB/s
broker.network.outbound.capacity=100000
